                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <button id="create" class="btn btn-success">创建管理员</button>
            ...
            $(function() {
				...
				ajax("web/admin/adminlist",null,function(data) {
    				...
    				for(var i = 0;i < list.length;i++) {
        				var updateButton = "<button id='update' adminId="+list[i].adminId+" class='btn btn-info'>修改</button>";
						var deleteButton = "<button id='delete' adminId="+list[i].adminId+" class='btn btn-danger'>删除</button>";
						$("#table").append("" +
