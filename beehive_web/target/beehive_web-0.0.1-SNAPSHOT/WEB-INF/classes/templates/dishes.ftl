	...
	<body class="skin-blue">
                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <div class="box-body table-responsive">
                                    <button id="create-dishes" class="btn btn-success">创建菜品</button>
                                    <table id="dishes-table" class="table table-bordered table-hover">
                                        <thead>
                                            <tr>
                                                <th>菜品ID</th>
                                                <th>菜品名称</th>
        ...
        <script type="text/javascript">
            $(function() {
				...
				ajax("web/dishes/disheslist",null,function(data) {
    				...
    				for(var i = 0;i < list.length;i++) {
        				var updateButton = "<button id='update-dishes' dishesId="+list[i].id+" class='btn btn-info'>修改</button>";
	                ...
	                //绑定按钮事件
	                $("button#create-dishes").click(function() {
	                	post("dishesEdit", {dishesId:0});
	                });
	                $("button#update-dishes").click(function() {
            ...
            function pic(id, path, button) {
            	...
            	if(path != "/") {
            		$("img#dishes-picture").attr("src", urlPrefix+"."+path);
	            ...
	            $("input#dishesPicture").AjaxFileUpload({
					...
					onComplete: function(filename, response) {
						...
						//更新图片显示
						if(p != "/") {
		            		$("img#dishes-picture").attr("src", urlPrefix+"."+p);
		            		$("img#dishes-picture").show();
		            	}
		            	else {
		            		$("img#dishes-picture").attr("src", "");
